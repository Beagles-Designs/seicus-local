...
class NinjaTablesAdmin
{
    ...
    public function updateTableSettings()
    {
        ...
        if (isset($_REQUEST['columns'])) {
            ...
            $rawColumns =  apply_filters('ninja_tables_before_update_settings', ninja_tables_sanitize_array($_REQUEST['columns']), $tableId);
    ...
    public function migrateIdAndTableIdColumn()
    {
        global $wpdb;
        $tableName = $wpdb->prefix . ninja_tables_db_table_name();
        $sql = "SELECT 
